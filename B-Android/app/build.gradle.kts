...
dependencies {
    ...
    // BrowserUiState/BrowserRuntimeViewModel memakai androidx.lifecycle.ViewModel dan
    // viewModelScope. Tanpa dependensi eksplisit ini, kompilasi unit test bergantung
    // pada kebetulan graf dependensi transitif — kalau appcompat/activity berhenti
    // menarik lifecycle-viewmodel-ktx, gate host akan jatuh dengan unresolved reference.
